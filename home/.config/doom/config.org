...
(after! org
  ...
  (setq org-todo-keywords
        '((sequence "ACTIVE(a)" "NEXT(n)" "TODO(T)" "[ ](t)" "PROJECT(p)" "|" "DONE(X)" "[X](x)")
          (sequence "WAITING(w)" "LATER(l)" "SOMEDAY(s)" "|" "CANCELLED(c)"))
...
(setq org-capture-templates
      `(("t" "todo" entry (file org-default-notes-file)
        ...
        ("e" "Emacs Todo" entry (file+headline ,(concat org-directory "/emacs.org") "Emacs Todos")
         "* TODO %?\n%U")
        ("b" "Browser" entry (file org-default-notes-file)
