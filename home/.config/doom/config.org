...
(after! org
  ...
  (setq org-todo-keywords
   ...
   '(("ACTIVE" :inherit warning :weight bold)
     ...
     ("REVIEW" :inherit 'org-todo :weight bold)
  ...
  (setq org-capture-templates
        `(("t" "todo" entry
          ...
          ("wr" "Work Review" entry
           (file+headline ,(concat org-directory "/Work/work.org") "Work Todos")
           "* REVIEW %(org-mac-chrome-get-frontmost-url)%?\n%U"))))
#+END_SRC
***** Src Block Snippets
#+BEGIN_SRC elisp :tangle no
             ...
             '("w" "Work" tags-todo "+WORK"
               ((org-agenda-sorting-strategy '(timestamp-down time-down))
                (org-super-agenda-groups '((:name "In Progress" :todo "ACTIVE")
                                           ...
                                           (:name "Next" :not (:todo "SOMEDAY" :todo "WAITING" :tag ("BACKLOG" "TEXT" "EMACS")))
                                           (:name "Waiting" :todo "WAITING")
                                           (:name "Backlog" :tag "BACKLOG")
                                           (:name "Reading List" :tag "TEXT"))))))
#+END_SRC
...
(map! (:map override
      ...
      ;; Text scale
      :niv "s-="   #'doom/increase-font-size
      :niv "s--"   #'doom/decrease-font-size
      :niv "s-0"   #'doom/reset-font-size)
#+END_SRC
