...
Disable the flycheck popup during insert mode, I dont want to see it while I'm typing.

#+BEGIN_SRC elisp
(after! flycheck
  :config
  (add-hook 'evil-insert-state-entry-hook (lambda () (setq flycheck-display-errors-function #'noop)))
  (add-hook 'evil-insert-state-exit-hook (lambda () (setq flycheck-display-errors-function #'+syntax-checker-show-popup))))
#+END_SRC
