...
(defun org-as-mac-chrome-get-frontmost-url-fix-title ()
  ...
  (setq org-capture-templates
        `(("t" "todo" entry
          ...
          ("wr" "Work Review" entry
           (file+headline ,(concat org-directory "/Work/work.org") "Work Todos")
           "* TODO %(org-as-mac-chrome-get-frontmost-url-fix-title)%? :REVIEW:\n%U "))))
#+END_SRC
***** Src Block Snippets
#+BEGIN_SRC elisp :tangle no
